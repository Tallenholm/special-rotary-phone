...
def test_10k_rejects_toc_duplicate_and_extracts_body_item_1a():
    ...
    """
    result = extract_sections(html, "10-K")
...
def test_10q_disambiguates_part_i_and_part_ii_items():
    ...
    """
    result = extract_sections(html, "10-Q")
...
def test_hashes_are_deterministic_and_match_text():
    ...
    """
    first = extract_sections(html, "10-K")["item_3_legal_proceedings"]
    second = extract_sections(html, "10-K")["item_3_legal_proceedings"]
    assert first == second
...
def test_unsupported_form_rejected():
    with pytest.raises(ValueError):
        extract_sections("<html></html>", "8-K")
